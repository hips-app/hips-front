    ...
    <div id="container">
      ...
      <div class="container-fluid">
        <div class="row align-items-start justify-content-center">
          <exercise-card
            v-for="{ id, name, desc, isSelectedEx, amountEx } in exerciseListToShow"
            :key="id"
            :id="id"
            :name="name"
            :desc="desc"
...
export default {
  ...
  watch: {
    ...
    foodListToEat(newListToDo) {
      localStorage.setItem('foodListToEat', JSON.stringify({ data: newListToDo }))
    },
  },
  data() {
    return {
      ...
      exerciseList: [
        ...
        },
        {
          id: 14,
          name: 'pork',
          desc: 'Maintain flexibility Maintain flexibility Maintain flexibility',
          type: 'protein',
        },
        {
          id: 15,
